...
docker build \
  --no-cache \
  --build-arg HTTP_PROXY=http://192.168.231.100:64291 \
  --build-arg HTTPS_PROXY=http://192.168.231.100:64291 \
  --build-arg FINAL_NAME=${image}:${TAG} \
  --build-arg SPARK_JAR_REPO_URL=${SPARK_JAR_REPO_URL} \
  -t ${image_customer}:${TAG} -f ./production_custom/Dockerfile ./production_custom
